...
export const About = () => {
  ...
  const btnBase = "px-6 md:px-8 py-3 md:py-4 rounded-lg font-bold text-[10px] md:text-[11px] uppercase tracking-[0.2em] transition-all text-center w-full md:w-auto";
  ...
  return (
    <section id="sobre" className="bg-black text-white py-32 px-4 md:px-8 overflow-hidden">
      <div className="max-w-[1440px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 items-center">
        ...
        >
          ...
          <h2 className="text-4xl md:text-6xl lg:text-8xl font-medium leading-[0.85] tracking-tighter mb-10 uppercase">
            A MENTE <br />
