      ...
      <div className="max-w-[1440px] mx-auto">
        ...
        <div className="flex justify-between items-end mb-20">
          ...
          >
            ...
            <h2 className="text-6xl md:text-8xl font-medium tracking-tighter uppercase">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {SOLUTIONS.map((item, i) => (
            ...
            >
              ...
              <div className="w-16 h-16 rounded-full bg-white/5 flex items-center justify-center mb-8 group-hover:bg-white transition-all duration-500">
              ...
              <p className="text-white/30 text-xs leading-relaxed mb-10 min-h-[60px]">
                {item.desc}
              </p>
